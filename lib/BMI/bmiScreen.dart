...
import 'package:newfolder/BMI/BMI_Cubit/cubit.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocConsumer<BMiCubit,BMiStates>(
        listener: (BuildContext context, BMiStates state) {  },
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text('${BMiCubit.get(context).weight}',
                                  style: TextStyle(
                                      fontSize: 40,
                                      fontWeight: FontWeight.w800
                                  ),),
                                Row(
                                  ...
                                  children: [
                                    IconButton(onPressed: (){
                                      setState(() {
                                        BMiCubit.get(context).weightIncrement();
                                      });
                                    }, icon: Icon(Icons.add),
                                    ),
                                    ...
                                    IconButton(onPressed: (){
                                      setState(() {
                                          BMiCubit.get(context).weightDecrement();
                                      });
